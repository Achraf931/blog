                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="category_id[]" id="category_id" multiple>
                                    ...
                                    <?php foreach ($categories as $key => $category) : ?>
                                        <?php $selectedCat = $db->prepare('SELECT * FROM article_category WHERE article_id = ? AND category_id = ?');
                                        $selectedCat->execute(array($_GET['article_id'], $category['id']));
                                        $recupCat = $selectedCat->fetch(); ?>
                                        <option value="<?= $category['id']; ?>" <?= isset($_GET['article_id']) && $recupCat ? 'selected' : ''; ?>>
                                            <?= $category['name']; ?>
                                        </option>
                                    <?php endforeach; ?>
                                </select>
